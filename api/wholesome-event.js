// POST /api/wholesome-event — lightweight funnel telemetry.
const { randomUUID } = require('node:crypto');
const { insert, readBody, isUuid } = require('./_supabase.js');

const ALLOWED = new Set(['started', 'concern_selected', 'reached_contact', 'completed', 'contact_submitted']);
